...
/**
 * @ngdoc function
 * @name wehrApp.controller:JqgridTestCtrl
 * @description
 * # JqgridTestCtrl
 * Controller of the wehrApp
 */
angular.module('wehrApp')
  .controller('JqgridTestCtrl', function ($scope) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
    ...
    $scope.config = {
    		...
    		height: 'auto',
    		width: 'auto',
    		colNames: ['Inv No', 'Date', 'Client', 'State', 'Amount', 'Tax', 'Total', 'Notes', 'Action'],
    		colModel: [
    		           ...
    		           }, datefmt: "Y-m-d", searchoptions: { sopt: ["eq", "ne", "lt", "le", "gt", "ge"] }},
    		        			   ...
    		        			   $(elem).kendoAutoComplete({
    		        				   ...
    		        				   select: function (e) {
    		        					   ...
    		        					   schedulerFactory.getPatientModelServices(DataItem.Id).then(function (data) {
	    		        					   ...
	    		        					   case 0: 
	    		        						   $('#patientSexSpan').html("Unspecfied"); 
	                                               break; 
	                                           case 1: 
	                                        	   $('#patientSexSpan').html("Male"); 
	                                               break; 
	                                           case 2: 
	                                        	   $('#patientSexSpan').html("Female"); 
	                                               break; 
	    		        					   }
    		        					   });
